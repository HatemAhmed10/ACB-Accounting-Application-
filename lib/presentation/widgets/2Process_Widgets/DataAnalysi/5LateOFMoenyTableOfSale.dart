...
class LateOFMoenyTableOfSale extends StatelessWidget {
  LateOFMoenyTableOfSale({super.key});
                        ...
                        child: Directionality(
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              for (var item
                                  in get_process_cubit.late_Moeny_Sale_process)
                                TableRow(
                                  children: [
                                    TableCell(
                                      child: Center(
                                ...
                                children: [
                                  TableCell(
                                    child: Container(
                                      ...
                                      child: Text(
                                        get_process_cubit
                                            .late_Moeny_Sale_process.length
                                            .toString(),
                                        style: TextStyle(
                                          color: Colors.red,
                                        ),
                                  ...
                                  TableCell(
                                    child: Center(
                                      child: Text(
                                        get_process_cubit.takeMoenyOSale
                                            .toString(),
                                        style: TextStyle(
                                          color: Colors.red,
                                        ),
